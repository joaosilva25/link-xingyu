  ...
  return (
    <>
      ...
      <section className="relative min-h-[60vh] pt-24 md:pt-0 md:min-h-[80vh] overflow-hidden bg-white">
        ...
        {/* Content */}
        <div className="relative z-10 mt-1 px-6 md:px-20 mx-auto md:py-30 w-full grid md:grid-cols-2 gap-12 items-center text-center md:text-left">
          ...
          <div className="text-white">
            ...
            >
              <button
                ...
                className="h-12 w-12 rounded-full mt-2 mb-6 border border-orange-200 bg-gradient-to-b from-white via-white to-white/60 shadow-[0_10px_24px_rgba(255,255,255,0.75)] backdrop-blur-sm animate-bounce cursor-default flex items-center justify-center"
              >
